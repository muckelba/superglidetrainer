        ...
        <div class="content">
            ...
            <div class="subtitle is-6">
                ...
                <ul>
                    ...
                    <li>
                        <strong>Visual cue</strong><br />You can also time it with the camera movement. Check in the top left or right corner. You view goes
                        from wobbling to completely still a few frames before the Superglide-window closes. So some people time it using that. I zoomed into the
                        corners in the
