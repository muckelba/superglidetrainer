        ...
        <div class="content">
            <ul>
                <li>
                    ...
                    <p class="subtitle is-6">
                        Find out the polling rate of your keyboard. That + some other small system delays is the lowest frame delay you can hit. The numbers
                        still don't make sense?
                    </p>
                    <p class="subtitle is-6">Your keyboard might scan the inputs in a weird way.</p>
                    <ul>
                        <li>In key clusters. So switching over 1 key left or right might get you out of one cluster and suddenly into the perfect delay.</li>
                        <li>
                        ...
                        <li>
                            Different scan rates or delays on your modifier keys (Spacebar, Shift, Ctrl etc.) So using Spacebar as jump input might never ever
                            work for you. Using two letters next to each other might be your solution.
                        </li>
                    </ul>

                    <p class="subtitle is-6">
                        So try what happens to your frame delay when you switch away from spacebar as jump input. Try out keys next to each other, in different
                        orders and keys far apart from each other. Try to use a keyboard-key for one input and a mouse-button for the other. This should help
                        you narrow down the issue. You may or may not want to use those exact keybinds in game. But it will help you narrow down what your
                    ...
                    <ul>
                        <li>
                            A faulty USB port or other system related latency Issues can be the cause of that. Switch USB ports. Check if your device drivers
                            are up to date. In extreme cases, problems with other components like your motherboard, CPU or operating system could be the cause.
                        </li>
                    </ul>
                </li>
            </ul>
        ...
        <div class="content">
            <ul>
                <li>
                    ...
                    <p class="subtitle is-6">
                        All our analytics are only in relation to hitting your jump -> Crouch timing. Your timing within the mantle is still totally up to
                        you....for now 😉
                    </p>
                    <ul>
                        <li>
                            <strong>Overall superglide consistency:</strong> Is the average chance out of all your attempts. 0% or 95% it gets counted. This gives
                            you a % number for the following question: If i attempted a Superglide in game, how likely am i to hit that Superglide?
                        </li>
                        <li>
        ...
        <div class="content">
            <ul>
                <li>
                    ...
                    <p class="subtitle is-6">
                        A Superglide is an instant 1 frame acceleration out of a mantle. Beyond just being fun this is a great way to throw of your enemies aim,
